...
export const navItems: NavItem[] = [
  ...
  { id: "workspace.install", href: "/downloads/Connect-Setup-0.1.1.exe", label: "Install", icon: "IN", lucide: Download, section: "workspace", sectionPermission: "can_view_section_workspace", permission: "can_view_workspace_contacts", download: true },
