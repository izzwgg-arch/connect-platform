...
export const navItems: NavItem[] = [
  ...
  { id: "crm.email", href: "/crm/email/settings", label: "Email", icon: "CE", lucide: Mail, section: "crm", sectionPermission: "can_view_section_crm", permission: "can_view_crm_settings" },
