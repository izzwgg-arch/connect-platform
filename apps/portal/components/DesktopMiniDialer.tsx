    ...
    <main className={"mini-shell" + (miniTheme === "light" ? " mini-light" : "")}>
      ...
      <style jsx>{`
        * { box-sizing: border-box; }
        ...
        .settings-toggle-row { -webkit-appearance: none; appearance: none; display: flex; align-items: center; justify-content: space-between; gap: 10px; padding: 10px 0; border: 0 !important; border-top: 0.5px solid var(--mn-line) !important; background: transparent !important; background-color: transparent !important; width: 100%; text-align: left; cursor: pointer; color: var(--mn-text); font: inherit; }
