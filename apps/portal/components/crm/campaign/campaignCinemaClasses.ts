...
export const mk = {
  ...
  rosterTableHead:
    "crm-cinema-roster-thead hidden lg:grid lg:grid-cols-[minmax(10rem,1.35fr)_minmax(7rem,0.72fr)_minmax(10rem,1fr)_minmax(8rem,0.8fr)_minmax(7.5rem,0.7fr)_minmax(8rem,0.72fr)_minmax(7rem,0.65fr)_auto] lg:gap-2 lg:px-4 lg:py-2 text-[10px] font-bold uppercase tracking-wider text-[var(--cinema-text-dim)]",
  memberRow:
    "crm-cinema-member-row grid grid-cols-1 gap-2 border-b border-[color:var(--cinema-border-subtle)] px-3 py-2.5 transition-[background,box-shadow] last:border-b-0 sm:px-4 lg:min-h-[46px] lg:grid-cols-[minmax(10rem,1.35fr)_minmax(7rem,0.72fr)_minmax(10rem,1fr)_minmax(8rem,0.8fr)_minmax(7.5rem,0.7fr)_minmax(8rem,0.72fr)_minmax(7rem,0.65fr)_auto] lg:items-center lg:gap-2 lg:px-4 lg:py-1.5",
  memberAvatar:
