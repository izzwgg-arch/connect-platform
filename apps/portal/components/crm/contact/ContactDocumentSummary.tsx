...
export function ContactDocumentSummary({ contactId, refreshToken = 0 }: Props) {
  ...
  return (
    <div className="rounded-[1.35rem] border border-crm-border/70 bg-crm-surface-2/45 p-4 flex flex-col gap-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-xs text-crm-muted">
            ...
            {summary.meta.documentCount !== 1 ? "s" : ""} with extracted text
            {summary.meta.intelligenceStatus === "COMPLETE" ? " · AI report available" : ""}
          </p>
        </div>
      ...
      <section>
        <p className="mb-1 text-[10px] font-bold uppercase tracking-[0.14em] text-emerald-400/90">
          Verified CRM fields
        </p>
      ...
      <section>
        <p className="mb-1 text-[10px] font-bold uppercase tracking-[0.14em] text-violet-300/90">
      ...
      <section>
        <p className="mb-2 flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-[0.14em] text-crm-muted">
          <Phone className="h-3 w-3" />
          All phones on file ({summary.phones.length})
        </p>
