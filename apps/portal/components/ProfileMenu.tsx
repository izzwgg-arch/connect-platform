    ...
    <div className="menu-wrap">
      ...
      <ViewportDropdown open={open} triggerRef={triggerRef} onClose={closeMenu} width={390} className="extension-control-panel">
        ...
        <section className="ecp-section" aria-label="Quick controls">
          ...
          <ControlToggle label="Voicemail transcription" detail={vmEmailTranscript ? "On — the written text goes in the email" : "Off — recording only"} checked={vmEmailTranscript} disabled={vmEmailSaving || !vmEmail} onChange={updateVmEmailTranscript} />
        </section>
