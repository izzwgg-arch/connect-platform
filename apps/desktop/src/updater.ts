...
type DiagLogger = (tag: string, message: string) => void;

let diag: DiagLogger = () => { /* replaced by initAutoUpdater */ };
...
export function initAutoUpdater(logger: DiagLogger): void {
  ...
  autoUpdater.on("update-downloaded", (info) => {
    ...
    const opts: MessageBoxOptions = {
      ...
      detail: "The update has been downloaded. Restart Connect to apply it now — or it'll be applied automatically next time you quit.",
