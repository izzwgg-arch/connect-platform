...
public class IncomingCallFirebaseService extends FirebaseMessagingService {
    ...
    private static final String CHANNEL_ID = "connect-incoming-ui-v4";
    ...
    private void handleIncomingCallNative(Map<String, String> data) {
        ...
        if (PRESENTATION_FOREGROUND_JS.equals(presentationMode)) {
            ...
            // We started ring at FCM entry; JS owns audio when already foreground.
        ...
        try {
            ...
            if (ringUri != null) {
                AudioAttributes aa = new AudioAttributes.Builder()
                    ...
                    .build();
                channel.setSound(ringUri, aa);
            } else {
                channel.setSound(null, null);
            }
        } catch (Exception e) {
            Log.w(TAG, "[CALL_INCOMING] channel setSound failed: " + e.getMessage());
            channel.setSound(null, null);
        }
