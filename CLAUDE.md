...
- 2026-09-15 · DISPLAY DECKS SPLIT: old tenant renamed NEXUS REALTY (Michael TENANT_ADMIN, Amex default, autopay OFF — his $65 Sola schedule is LIVE, next Sep 26); new billing-only tenant DISPLAYDX (Ellie, Visa default, autopay ON, $30/mo); Ellie's 3 missed cycles CC-202609-00007/8/9 emailed-then-CHARGED on his GO, all PAID $90, receipts SENT; ⛔⛔ phone/IVR move STOPPED before any live write — a 2nd TenantPbxLink to the same PBX tenant 6 breaks ringing (`resolvePbxEventTarget` unordered findFirst → app never rings), CDRs and IVR import; rendered dialplan proves 845-414-3736 + ext 104 are NEXUS; Izzy to pick A real PBX split / B platform rework / C leave → `2026-09-15-displaydx-nexus-realty-split.md`
