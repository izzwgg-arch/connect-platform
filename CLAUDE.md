...
- 2026-09-17 · YIDDISH LEARNING ENGINE + YIDDISH24 — RUNNING 24/7 until Izzy says "stop listening Yiddish24" (api `7c2554c8`): ⛔⛔ 09-17 it had PAUSED ITSELF on one Yiddish24 524 (every 5xx was filed as a refusal) — resumed + fixed: origin 5xx = outage, retries, never pauses; 403/429/503/challenge still hard-stop; whole catalog walked, hourly re-check; Now listening panel; NO MUSIC. METADATA ONLY — ⛔⛔ 0 audio bytes: pronunciation/accent/dialect/slang/rhythm ALL need audio, which needs Yiddish24's written permission (draft §2b) — never bypass the hotlink block. ⛔ pinned OLDER-SHA deploys revert it — deploy the origin tip → `2026-09-15-yiddish-learning-engine.md`
