...
- 2026-09-15 · Helper audit.jsonl is 84.8 GB, unbounded — rotation DESIGNED not implemented (result-size cap in audit() is the real fix + in-process rename rotation, no root parts; installer renames backlog aside, deletes only on Izzy's flag; ⛔ build on the `526b56ba` tip, helper source lives twice) → `2026-09-15-helper-audit-jsonl-rotation-design.md`
