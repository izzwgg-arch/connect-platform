...
- 2026-09-15 · Browser Companion: MV3 is Loopcom-branded but NOT ready to install (unloaded/unpaired; live pairing/provider, recovery/stress, existing-session consent + distribution unproven). Active installed candidate instead drives an isolated branded Chrome profile via Playwright Core, scoped tabs + state-bound one-use approvals. IDE-style Coworker chat mockup previewed in identical light/dark layouts; no UI build yet → `2026-09-14-browser-companion.md`
