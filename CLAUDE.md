...
- GOOGLE PLAY STORE: vc101 LIVE since 09-07; store icon swapped to blue-2b 512 + SUBMITTED 09-15 ("Changes in review", auto-live on approval); Android-15 FGS warning TRIAGED — static-scan boilerplate, code catches it (no crash expected, keepalive skips until app open), real fix due in vc102 → `2026-08-29-google-play-store-the-organization-account-exist.md`
