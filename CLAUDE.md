...
- ⏳ **Still open on this account:** her **Connect invitation email named "a plus center"** (she has since gone **ACTIVE**, so she signed in under the old name — a re-invite via `POST /admin/users/:id/resend-invite` would carry the new one, not yet done, Izzy's call), and **$45 was really charged** against a sign-up that carried someone else's details.
