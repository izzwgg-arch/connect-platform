...
- GOOGLE PLAY STORE: vc101 LIVE since 09-07; store icon swapped to blue-2b 512 and SUBMITTED 09-15 ("Changes in review" — auto-live on approval, then phone-side cache lag); Android-15 FGS/BOOT_COMPLETED warning open → `2026-08-29-google-play-store-the-organization-account-exist.md`
