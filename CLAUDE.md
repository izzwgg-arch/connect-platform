...
- 2026-09-18 · CUSTOMER COST BREAKDOWN (office-only "what this customer cost us" card on each invoice: inbound/outbound minutes, texts, CNAM lookups, numbers/911, services, margin) — MOCKUPS ONLY, awaiting Izzy: https://claude.ai/artifact/BMtViAYuCsesLP9gNCYLVx (repo copy `docs/mockups/customer-cost-breakdown/v1/`); volumes = Gesheft’s real Aug 3–Sep 3 (11,036 in / 8,759 out min, 783 texts, 5,375 CNAM), rates illustrative; ⛔ ConnectCdr has NO cost field and nothing pulls carrier CDR costs; ⛔ outbound = shared Telocall 0001 with NO API → only minutes × a typed rate; CNAM lookups (~$43/mo at list) may be the biggest surprise, unverified; nothing built → `2026-09-18-customer-cost-breakdown-mockups.md`
