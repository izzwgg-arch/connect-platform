...
- ⏳ **NOT PROVEN:** nobody has opened the link on a real phone, no camera frame has been decoded in production, and no customer has scanned a sticker. Deployment recorded below once container-verified.
