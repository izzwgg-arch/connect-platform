...
- ✅ **Yealink Partner Agreement SIGNED 2026-09-14 11:32 (In Effect, expires 2029-09-14)** — account.yealink.com, company "connect communications" (A1124985). It does not by itself grant RPS/API; tickets #530705 (RPS + API + AccessKey) and #530712 (US YMCS SP account) are still pending. ⛔ **YMCS has NO self-signup** (login page = Sign In / Microsoft SSO only) and Izzy never had a YMCS account — Yealink must create it. Follow-ups posted on both tickets 2026-09-14 ~00:29 ET saying the agreement is signed and asking for the US YMCS SP account + RPS API. Only an AI auto-reply so far; watch izzy@loopcom.net. Memory: [[yealink-rps-account-and-ticket]].
