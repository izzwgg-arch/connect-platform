...
export const metadata: Metadata = {
  title: 'Download LoopCom Works App',
  description: 'Download the LoopCom Works Android app (APK) for field technicians.',
}
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-3">
        <p className="text-sm font-semibold uppercase tracking-wide text-primary">android app</p>
        <h1 className="text-3xl font-bold text-gray-900 sm:text-4xl">Download LoopCom Works</h1>
        <p className="max-w-2xl text-gray-700">
          Install the LoopCom Works app on your Android phone to manage jobs, requests, time tracking,
        ...
        <CardContent className="space-y-6 p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <a
              href={APK_PATH}
              download
              className="inline-flex items-center justify-center rounded-md bg-primary px-5 py-3 text-sm font-semibold text-white hover:bg-[#243b47]"
            >
          ...
          <div className="rounded-lg border bg-gray-50 p-4 text-sm text-gray-700">
            ...
            <ol className="list-decimal space-y-1 pl-5">
              ...
              <li>Tap Install, then open LoopCom Works and sign in.</li>
            </ol>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-2 text-sm text-gray-700">
            <p>Only download from this LoopCom Works page.</p>
