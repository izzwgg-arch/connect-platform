...
import { Save, Plus, Trash2, Copy, Eye, EyeOff, MessageSquare } from 'lucide-react'
  ...
  const fetchPurchaseOrder = async () => {
    ...
    try {
      ...
      setFormData({
        ...
        deliveryAddress: po.deliveryAddress || po.jobSiteAddress || '',
