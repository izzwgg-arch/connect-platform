  ...
  ({ className, type, onWheel, onKeyDown, onChange, value, calculator, inputMode, ...props }, ref) => {
    ...
    return (
      <input
        ...
        className={cn(
          "flex h-11 min-h-[44px] w-full rounded-lg border border-line-strong bg-panel-2 px-3 py-2 text-base sm:text-sm text-ink ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-faint transition-colors hover:border-primary/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:border-transparent disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        ref={ref}
        value={value}
