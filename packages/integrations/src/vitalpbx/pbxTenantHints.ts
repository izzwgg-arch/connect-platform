/**
 * Extract VitalPBX tenant identity hints from Asterisk channel names and dialplan contexts.
 * Used by telephony (live) and API ingest — keep logic identical.
 */
...
/** Parse slug suffix from Vital-style contexts: ext-local-{slug}, from-pstn-{slug}, etc. */
...
/** t8_cos-* → dialplan index "8" and canonical code T8 */
...
/**
 * PJSIP endpoint patterns seen on VitalPBX:
 * - PJSIP/T8_101-0000abcd
 * - PJSIP/344822_slug-0000abcd
 */
