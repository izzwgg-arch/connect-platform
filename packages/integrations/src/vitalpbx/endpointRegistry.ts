...
export const VITALPBX_ENDPOINTS: VitalPbxEndpointDefinition[] = [
  ...
  { key: "authorizationCodes.create", folder: "Authorization Codes", method: "POST", path: "/api/v2/auth_codes", tenantAware: true, capability: "authorizationCodes.crud", pbxConfigMutation: true },
  { key: "authorizationCodes.updatePut", folder: "Authorization Codes", method: "PUT", path: "/api/v2/auth_codes/:id", tenantAware: true, capability: "authorizationCodes.crud", pbxConfigMutation: true },
  { key: "authorizationCodes.updatePatch", folder: "Authorization Codes", method: "PATCH", path: "/api/v2/auth_codes/:id", tenantAware: true, capability: "authorizationCodes.crud", pbxConfigMutation: true },
  { key: "authorizationCodes.delete", folder: "Authorization Codes", method: "DELETE", path: "/api/v2/auth_codes/:id", tenantAware: true, capability: "authorizationCodes.crud", pbxConfigMutation: true },
  ...
  { key: "aiApiKeys.create", folder: "AI API Keys", method: "POST", path: "/api/v2/ai_api_keys", tenantAware: true, capability: "aiApiKeys.crud", pbxConfigMutation: true },
  { key: "aiApiKeys.update", folder: "AI API Keys", method: "PUT", path: "/api/v2/ai_api_keys/:id", tenantAware: true, capability: "aiApiKeys.crud", pbxConfigMutation: true },
  { key: "aiApiKeys.delete", folder: "AI API Keys", method: "DELETE", path: "/api/v2/ai_api_keys/:id", tenantAware: true, capability: "aiApiKeys.crud", pbxConfigMutation: true },
  ...
  { key: "customerCodes.create", folder: "Customer Codes", method: "POST", path: "/api/v2/customer_codes", tenantAware: true, capability: "customerCodes.crud", pbxConfigMutation: true },
  { key: "customerCodes.updatePut", folder: "Customer Codes", method: "PUT", path: "/api/v2/customer_codes/:id", tenantAware: true, capability: "customerCodes.crud", pbxConfigMutation: true },
  { key: "customerCodes.updatePatch", folder: "Customer Codes", method: "PATCH", path: "/api/v2/customer_codes/:id", tenantAware: true, capability: "customerCodes.crud", pbxConfigMutation: true },
  { key: "customerCodes.delete", folder: "Customer Codes", method: "DELETE", path: "/api/v2/customer_codes/:id", tenantAware: true, capability: "customerCodes.crud", pbxConfigMutation: true },
  ...
  { key: "queues.create", folder: "Queues", method: "POST", path: "/api/v2/queues", tenantAware: true, capability: "queues.crud", pbxConfigMutation: true },
  { key: "queues.update", folder: "Queues", method: "PUT", path: "/api/v2/queues/:queueId", tenantAware: true, capability: "queues.crud", pbxConfigMutation: true },
  { key: "queues.delete", folder: "Queues", method: "DELETE", path: "/api/v2/queues/:queueId", tenantAware: true, capability: "queues.crud", pbxConfigMutation: true },
  ...
  { key: "tenants.create", folder: "Tenants", method: "POST", path: "/api/v2/tenants", capability: "tenants.crud", pbxConfigMutation: true },
  { key: "tenants.update", folder: "Tenants", method: "PUT", path: "/api/v2/tenants/:tenantId", capability: "tenants.crud", pbxConfigMutation: true },
  { key: "tenants.delete", folder: "Tenants", method: "DELETE", path: "/api/v2/tenants/:tenantId", capability: "tenants.crud", pbxConfigMutation: true },
  { key: "tenants.changeState", folder: "Tenants", method: "PATCH", path: "/api/v2/tenants/:tenantId/:state", capability: "tenants.crud", notes: "state: enable|disable", pbxConfigMutation: true },
  { key: "tenants.applyChanges", folder: "Tenants", method: "PUT", path: "/api/v2/tenants/:tenantId/apply_changes", capability: "tenants.crud", pbxConfigMutation: true },
  ...
  { key: "tenants.addInboundNumbers", folder: "Tenants", method: "PATCH", path: "/api/v2/tenants/:tenantId/inbound_numbers", capability: "tenants.crud", pbxConfigMutation: true },
  { key: "tenants.removeInboundNumbers", folder: "Tenants", method: "DELETE", path: "/api/v2/tenants/:tenantId/inbound_numbers", capability: "tenants.crud", pbxConfigMutation: true },
