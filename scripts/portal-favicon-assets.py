...
THE FAVICON IS THE DESIGNER'S PLATED TILE. DO NOT CUT THE BACKGROUND AWAY.
--------------------------------------------------------------------------
Izzy, 2026-08-31, comparing the two hostnames: "connectcommunications has a
nice favicon. That same favicon should go in loopcom.net." The nice one is
THIS one - the designer's hand-drawn frames, mark on its blue plate, filling
the whole box.

Between 2026-08-23 and 2026-08-31 this script instead recovered the mark from
the flattened tile and shipped it with the plate keyed out and the band scaled
edge to edge. That is REVERTED and must not come back. It measured 14% opaque
at 16px against 100% here, with the ink confined to rows 3-11 of 16 - a thin
wide band that reads washed out in a tab strip. Izzy reported it as "wider,
not really visible too well".

  #  Every reason the cut-away version gave for itself - the optical drop, the
  #  centring guard, the flare-trim analysis - only existed to make a keyed-out
  #  band sit level with the tab title. None of it applies to a full-bleed
  #  square: the designer's frames fill 0..16 in both axes, so there is nothing
  #  to centre and no drop to tune. If you find yourself re-deriving any of
  #  that, you are rebuilding the version that was rejected.
